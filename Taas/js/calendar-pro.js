(function(){
	...
	calendarDate.date = calendarDate.today.getDate();//当前日ht-rili-day
	...
	function dateClick(obj){
		$(obj).each(function(){
			if($(this).hasClass('ht-rili-td-active')){
				$(this).removeClass('ht-rili-td-active');
				for(var i = 0 ; i<arrData.length ; i++){
					if ($(this).attr('data-date') == arrData[i]) {
						arrData.splice(i,1)
						$(".arrData_input").val(arrData)
					}
				}
			}else{
				$(this).addClass('ht-rili-td-active');
				arrData.push($(this).attr('data-date'))
	...
	$.fn.extend({
	    calendar:function(opt){
	        ...
	        //加载容器
	    	calendarDate.container = '<div class="ht-rili-querybox"><strong class="ht-rili-title">'+ opt.title +'</strong><div class="ht-rili-datebox"><span class="ht-rili-leftarr"></span><span class="ht-rili-date"></span><span class="ht-rili-rightarr"></span></div><div class="ht_rili_confirm_canel_box"><span class="confirm">确定</span><span class="canel">取消</span><input type="hidden" class="arrData_input"/></div></div><div class="ht-rili-head"><div class="ht-rili-th">周日</div><div class="ht-rili-th">周一</div><div class="ht-rili-th">周二</div><div class="ht-rili-th">周三</div><div class="ht-rili-th">周四</div><div class="ht-rili-th">周五</div><div class="ht-rili-th">周六</div></div><div class="ht-rili-body"><!--<div class="ht-rili-td"><span class="ht-rili-day">1</span><span class="ht-rili-money">&yen;100</span></div>--></div>'
